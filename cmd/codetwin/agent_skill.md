...
description: >
  ...
  Go, JavaScript, TypeScript, Python, Java, Rust, Elixir, or C. Also trigger when the user says things
...
Go, JavaScript/TypeScript, Python, Java, Rust, Elixir, and C. Function-level
