...
//	         test/testN (test.c, test1.c), or a test/ or tests/ directory
//	         component; .h files follow the same rule
//
...
// _unittest, and test harness drivers named test, test1, test2, ...
func cTestStem(stem string) bool {
	...
	for _, suffix := range []string{"_test", "_tests", "-test", "_unittest"} {
